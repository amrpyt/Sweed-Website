...
```bash
INIT=$(node "/media/amr/02D804FAD804EE2B/Busniss/SWEED-Website/.claude/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @/media/amr/02D804FAD804EE2B/Busniss/SWEED-Website/.claude/get-shit-done/templates/spec.md.
