...
(() => {
  ...
  const ensurePortfolioPolish = () => {
    ...
    style.textContent = [
      ...
      ".sweed-reference-page #marketing-work .mkt-proj.show { display: flex !important; height: 25.5rem; min-height: 25.5rem; flex-direction: column; align-items: stretch !important; text-align: right !important; }",
      ...
      "@media (max-width: 48rem) { .sweed-reference-page #media-work .sec-lead { white-space: normal; font-size: .96rem !important; } .sweed-reference-page #marketing-work .mkt-grid { grid-template-columns: 1fr !important; } .sweed-reference-page #marketing-work .mkt .phone { width: min(100%, 16rem); margin-inline: auto; } .sweed-reference-page #marketing-work .mkt-proj.show { height: auto; min-height: 0; } .sweed-reference-page #marketing-work .mkt-proj .btn, .sweed-reference-page .portfolio-service-link, .sweed-reference-page #web-work .ux-notes .btn { width: min(100%, 17.5rem) !important; min-width: min(100%, 17.5rem) !important; } .sweed-reference-page #web-work .browser, .sweed-reference-page .portfolio-system-slider { min-height: 20rem; } }",
