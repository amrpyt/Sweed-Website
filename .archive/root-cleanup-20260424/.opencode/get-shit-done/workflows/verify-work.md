...
<template>
@/media/amr/02D804FAD804EE2B/Busniss/SWEED-Website/.opencode/get-shit-done/templates/UAT.md
</template>
...
Read and follow `/media/amr/02D804FAD804EE2B/Busniss/SWEED-Website/.opencode/get-shit-done/workflows/transition.md`.
...
```bash
node "/media/amr/02D804FAD804EE2B/Busniss/SWEED-Website/.opencode/get-shit-done/bin/gsd-tools.cjs" audit-open --json 2>/dev/null
```
...
- Follow @/media/amr/02D804FAD804EE2B/Busniss/SWEED-Website/.opencode/get-shit-done/workflows/diagnose-issues.md
