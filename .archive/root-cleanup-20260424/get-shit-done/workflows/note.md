...
- **Global scope**: `/media/amr/02D804FAD804EE2B/Busniss/SWEED-Website/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/media/amr/02D804FAD804EE2B/Busniss/SWEED-Website/notes/`)
...
2. Glob `/media/amr/02D804FAD804EE2B/Busniss/SWEED-Website/notes/*.md` (if directory exists) — global notes
...
Global (/media/amr/02D804FAD804EE2B/Busniss/SWEED-Website/notes/):
...
2. **No `.planning/`**: Falls back to global `/media/amr/02D804FAD804EE2B/Busniss/SWEED-Website/notes/` — works in any directory
