...
<reference>
@/media/amr/02D804FAD804EE2B/Busniss/SWEED-Website/.opencode/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `/media/amr/02D804FAD804EE2B/Busniss/SWEED-Website/.opencode/get-shit-done/references/user-profiling.md` to load:
