...
@/media/amr/02D804FAD804EE2B/Busniss/SWEED-Website/get-shit-done/references/thinking-models-research.md
...
```bash
node "/media/amr/02D804FAD804EE2B/Busniss/SWEED-Website/get-shit-done/bin/gsd-tools.cjs" graphify query "<capability-keyword>" --budget 1500
```
