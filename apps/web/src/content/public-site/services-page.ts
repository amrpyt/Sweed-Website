...
const executiveServices: readonly ExecutiveServiceSource[] = [
  {
    ...
    actionLabel: "ناقش خدمة الاستشارات الإدارية والتسويقية",
  ...
  },
  {
    ...
    actionLabel: "ناقش خدمة بناء البراند والهوية البصرية",
  ...
  },
  {
    ...
    actionLabel: "ناقش خدمة التسويق الرقمي وإدارة الحملات",
  ...
  },
  {
    ...
    actionLabel: "ناقش خدمة المواقع والأنظمة والحلول الرقمية",
    composition: "system",
  },
  {
    id: "advertising",
    ...
    actionLabel: "ناقش خدمة الدعاية والإعلان",
  ...
  },
  {
    ...
    actionLabel: "ناقش خدمة إنتاج المحتوى والميديا",
    composition: "studio",
  },
];
...
export const servicesPageSource = {
  ...
  hero: {
    ...
    actions: [
      { label: "احجز استشارتك المجانية", href: "/contact?source=services", variant: "primary" },
