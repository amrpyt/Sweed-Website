...
<required_reading>
Read `/media/amr/02D804FAD804EE2B/Busniss/SWEED-Website/get-shit-done/references/ai-frameworks.md` for framework profiles and known pitfalls before fetching docs.
</required_reading>
