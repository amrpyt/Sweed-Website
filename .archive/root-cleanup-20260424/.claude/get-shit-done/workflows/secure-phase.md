...
```
Task(
  prompt="Read /media/amr/02D804FAD804EE2B/Busniss/SWEED-Website/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/media/amr/02D804FAD804EE2B/Busniss/SWEED-Website/.claude/get-shit-done/templates/SECURITY.md`
