...
<required_reading>
Read `/media/amr/02D804FAD804EE2B/Busniss/SWEED-Website/.opencode/get-shit-done/references/ai-evals.md` — specifically the rubric design and domain expert sections.
</required_reading>
