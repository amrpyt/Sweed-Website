...
- If a legacy HTML patch is unavoidable, document it as temporary, keep it small, and create/follow an OpenSpec task to migrate that behavior into modular React.
