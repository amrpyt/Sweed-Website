...
- Typography: Arabic-first sans. Current production font is self-hosted `SF Arabic`; Tajawal remains an acceptable fallback for admin or future font migration.
