...
```bash
node "/media/amr/02D804FAD804EE2B/Busniss/SWEED-Website/.opencode/get-shit-done/bin/gsd-tools.cjs" audit-open 2>/dev/null
```
...
**If doesn't exist:** Create from template at `/media/amr/02D804FAD804EE2B/Busniss/SWEED-Website/.opencode/get-shit-done/templates/retrospective.md`.
