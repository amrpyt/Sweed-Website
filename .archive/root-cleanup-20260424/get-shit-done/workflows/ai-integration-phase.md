...
<required_reading>
@/media/amr/02D804FAD804EE2B/Busniss/SWEED-Website/get-shit-done/references/ai-frameworks.md
@/media/amr/02D804FAD804EE2B/Busniss/SWEED-Website/get-shit-done/references/ai-evals.md
</required_reading>
...
```markdown
Read /media/amr/02D804FAD804EE2B/Busniss/SWEED-Website/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "/media/amr/02D804FAD804EE2B/Busniss/SWEED-Website/get-shit-done/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read /media/amr/02D804FAD804EE2B/Busniss/SWEED-Website/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read /media/amr/02D804FAD804EE2B/Busniss/SWEED-Website/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read /media/amr/02D804FAD804EE2B/Busniss/SWEED-Website/agents/gsd-eval-planner.md for instructions.
