...
Key references:
- @/media/amr/02D804FAD804EE2B/Busniss/SWEED-Website/get-shit-done/references/ui-brand.md (display patterns)
- @/media/amr/02D804FAD804EE2B/Busniss/SWEED-Website/get-shit-done/agents/gsd-user-profiler.md (profiler agent definition)
- @/media/amr/02D804FAD804EE2B/Busniss/SWEED-Website/get-shit-done/references/user-profiling.md (profiling reference doc)
</required_reading>
...
```bash
PROFILE_PATH="/media/amr/02D804FAD804EE2B/Busniss/SWEED-Website/get-shit-done/USER-PROFILE.md"
...
```bash
cp "/media/amr/02D804FAD804EE2B/Busniss/SWEED-Website/get-shit-done/USER-PROFILE.md" "/media/amr/02D804FAD804EE2B/Busniss/SWEED-Website/USER-PROFILE.backup.md"
```
...
✓ Stores profile at /media/amr/02D804FAD804EE2B/Busniss/SWEED-Website/get-shit-done/USER-PROFILE.md
...
- The user-profiling reference doc at `/media/amr/02D804FAD804EE2B/Busniss/SWEED-Website/get-shit-done/references/user-profiling.md`
...
Reference: @/media/amr/02D804FAD804EE2B/Busniss/SWEED-Website/get-shit-done/references/user-profiling.md
...
Display: "✓ Profile written to /media/amr/02D804FAD804EE2B/Busniss/SWEED-Website/get-shit-done/USER-PROFILE.md"
...
- options (ALL pre-selected by default):
  ...
  - "Global .clinerules" -- "Add profile to /media/amr/02D804FAD804EE2B/Busniss/SWEED-Website/.clinerules for all projects"

**If no artifacts selected:** Display "No artifacts generated. Your profile is saved at /media/amr/02D804FAD804EE2B/Busniss/SWEED-Website/get-shit-done/USER-PROFILE.md" and jump to step 10.
...
Display: "✓ Generated /gsd-dev-preferences at /media/amr/02D804FAD804EE2B/Busniss/SWEED-Website/commands/gsd/dev-preferences.md"
...
Display: "✓ Added profile section to /media/amr/02D804FAD804EE2B/Busniss/SWEED-Website/.clinerules"
...
```bash
BACKUP_PATH="/media/amr/02D804FAD804EE2B/Busniss/SWEED-Website/USER-PROFILE.backup.md"
```
...
Your profile:    /media/amr/02D804FAD804EE2B/Busniss/SWEED-Website/get-shit-done/USER-PROFILE.md
```

Then list paths for each generated artifact:
```
Artifacts:
  ✓ /gsd-dev-preferences   /media/amr/02D804FAD804EE2B/Busniss/SWEED-Website/commands/gsd/dev-preferences.md
  ✓ .clinerules section       .clinerules
  ✓ Global .clinerules        /media/amr/02D804FAD804EE2B/Busniss/SWEED-Website/.clinerules
```
