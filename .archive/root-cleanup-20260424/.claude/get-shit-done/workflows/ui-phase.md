...
```markdown
Read /media/amr/02D804FAD804EE2B/Busniss/SWEED-Website/.claude/agents/gsd-ui-researcher.md for instructions.
...
Template: /media/amr/02D804FAD804EE2B/Busniss/SWEED-Website/.claude/get-shit-done/templates/UI-SPEC.md
</output>
...
```markdown
Read /media/amr/02D804FAD804EE2B/Busniss/SWEED-Website/.claude/agents/gsd-ui-checker.md for instructions.
