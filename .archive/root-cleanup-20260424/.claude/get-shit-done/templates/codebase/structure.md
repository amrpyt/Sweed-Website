...
- Usage: Reference from command with `@/media/amr/02D804FAD804EE2B/Busniss/SWEED-Website/.claude/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to /media/amr/02D804FAD804EE2B/Busniss/SWEED-Website/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /media/amr/02D804FAD804EE2B/Busniss/SWEED-Website/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
