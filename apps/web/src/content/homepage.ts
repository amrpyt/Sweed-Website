...
export const homepageContent = {
  hero: {
    ...
    subtitle:
      "بنحدد اتجاه مشروعك بالتحليل والأرقام، ونمشي معاك في التنفيذ خطوة بخطوة، لحد ما النتايج تتحسن وتبقى قابلة للقياس.",
    trustLine: "خبرة من 2011 · أكثر من 300 مشروع · شراكات طويلة المدى",
    actions: [
  ...
  problems: [
    ...
    },
    {
      ...
      serviceKey: "التصميم والهوية البصرية",
    },
    {
  ...
  about: {
    ...
    paragraphs: [
      "سويد شركة استشارات إدارية وتسويقية شغالة في السوق المصري والعربي من 2011.",
      "شغلتنا الأساسية: نحوّل الأفكار لمشروعات شغالة وبتكسب، ونرجّع المشروعات المتعثرة لمسار النمو تاني.",
      "إحنا مش جهة بتنفذ طلب وتمشي، ولا بنبيع خطط ورق. بنشتغل زي البوصلة: نفهم وضعك الأول، نحدد الاتجاه بالبيانات، نرسم المسار، وننفذ معاك ونقيس — لحد ما توصل.",
      "واسم سويد نفسه مش اسم تجاري وبس؛ ده اسم عيلة مصرية معروفة بالوفاء والالتزام بالكلمة. فلما بنقولك «معًا ستصل»، ده وعد عيلة قبل ما يكون شعار شركة.",
    ],
    points: [
      {
      ...
      },
      {
        ...
        summary: "استشارات وتسويق وتصميم وبرمجة وميديا في اتجاه واحد.",
  ...
  offers: [
    ...
    },
    {
      ...
      ctaLabel: "احجز مكالمة تحول رقمي",
    },
  ] satisfies HomeCard[],
  offersTail:
  ...
  faq: [
    ...
    {
      title: "بتشتغلوا مع أنهي قطاعات؟",
      summary:
        "خبرتنا الأقوى في العقارات، المطاعم والأغذية، التجارة والتجزئة، والطبي والتعليمي والنقل والحماية المدنية والخدمات، مع المشروعات الصغيرة والمتوسطة في مصر والوطن العربي.",
      icon: "fa-layer-group",
    },
    {
      title: "ليه أختاركم عن أي حد تاني؟",
      summary:
        "لأن إحنا مش بنبيع خطة ونمشي — بنحدد الاتجاه بالبيانات، وننفذ معاك، ونفضل موجودين بالقياس والمتابعة. ده الفرق بين مورد بيقفل طلب وشريك ماشي معاك.",
      icon: "fa-handshake",
    },
    {
      title: "في دعم بعد التسليم؟",
      summary:
        "أيوه — الدعم والمتابعة جزء أصيل من طريقة شغلنا مش خدمة إضافية. بنتفق على فترة الدعم ونطاقه في العقد بوضوح.",
      icon: "fa-headset",
    },
  ] satisfies HomeCard[],
  contact: {
  ...
  aiSupport: {
    ...
    prompts: [
      ...
      },
      {
        ...
        answer:
          "6 خدمات متكاملة: استشارات إدارية وتسويقية، هوية بصرية، تسويق رقمي، برمجة وتطوير، دعاية وإعلان، وإنتاج ميديا — كلها بتشتغل في اتجاه واحد لصالح مشروعك. عايز تفاصيل خدمة معينة؟",
      },
      {
