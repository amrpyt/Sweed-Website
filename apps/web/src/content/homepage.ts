...
export const homepageContent = {
  ...
  portfolio: [
    {
      ...
      meta: "حالة موثقة",
      image: "/images/articles/mixed/mixed-strategy.webp",
    ...
    },
    {
      ...
      meta: "قيد التوثيق",
      image: "/images/articles/mixed/mixed-budget.webp",
    ...
    },
    {
      ...
      meta: "قيد التوثيق",
      image: "/images/articles/mixed/mixed-package.webp",
      result: "النتيجة الرقمية قيد التوثيق",
      verification: "pending",
    },
    {
      ...
      summary:
        "منصة تجمع رحلة العميل في مسار واضح من أول الاستفسار حتى إتمام الطلب، مع تجربة استخدام سريعة وقابلة للقياس.",
      icon: "fa-laptop-code",
      href: "/portfolio",
      category: "المواقع والحلول الرقمية",
      meta: "قيد التوثيق",
      image: "/images/articles/mixed/mixed-ai.webp",
      result: "النتيجة الرقمية قيد التوثيق",
      verification: "pending",
    },
    {
      title: "حملة نمو وتسويق",
      summary:
        "إعادة ترتيب الرسائل والإعلانات والقياس حول هدف تجاري واحد، عشان الميزانية تتحرك في اتجاه مفهوم وقابل للتحسين.",
      icon: "fa-chart-line",
      href: "/portfolio",
      category: "التسويق الرقمي",
      meta: "قيد التوثيق",
      image: "/images/articles/mixed/mixed-ads.webp",
      result: "النتيجة الرقمية قيد التوثيق",
      verification: "pending",
    },
    {
      title: "هوية تجارية جديدة",
      summary:
        "نظام بصري ورسائل متماسكة يخلوا العلامة واضحة في كل نقطة تواصل، من المطبوعات لحد الظهور الرقمي.",
      icon: "fa-palette",
      href: "/portfolio",
      category: "البراند والهوية",
      meta: "قيد التوثيق",
      image: "/images/articles/mixed/mixed-brand.webp",
      result: "النتيجة الرقمية قيد التوثيق",
      verification: "pending",
    },
  ] satisfies HomeCard[],
  ...
  offersTail:
    "مش لاقي باقتك؟ عادي — بنفصّل نطاق شغل على مقاس مشروعك. سيب لنا تفاصيل الباقة والبنود اللي محتاجها.",
  servicesIntro:
  ...
  articles: [
    {
      ...
      meta: "6 دقائق",
      image: "/images/articles/latest/direction.webp",
    },
    {
      title: "دليل تشخيص عائد الإعلانات",
      summary:
    ...
    },
    {
      ...
      meta: "7 دقائق",
      image: "/images/articles/latest/brand.webp",
    },
    {
      title: "اختيار الباقة التسويقية المناسبة",
      summary: "طريقة عملية تربط الباقة بمرحلة مشروعك وميزانيتك والهدف اللي محتاج تحققه بدل الاختيار العشوائي.",
      icon: "fa-layer-group",
      href: "/articles/how-to-choose-marketing-package",
      category: "التسويق",
      meta: "4 دقائق",
      image: "/images/articles/latest/package.webp",
    },
    {
      title: "كيف يساعد AI Demo قرار العميل؟",
      summary: "العميل بيفهم أسرع لما يشوف تجربة حقيقية قدامه بدل ما يحاول يتخيل الخدمة من وصف طويل.",
      icon: "fa-microchip",
      href: "/articles/why-ai-demo-helps-sales",
      category: "حلول رقمية",
      meta: "3 دقائق",
      image: "/images/articles/latest/ai.webp",
    },
    {
      title: "5 أرقام قبل زيادة ميزانية التسويق",
      summary: "مؤشرات بسيطة تكشف هل الحملة بتتحسن فعلًا ولا الميزانية بتضيع في حركة من غير نتيجة.",
      icon: "fa-chart-column",
      href: "/articles/marketing-metrics-that-matter",
      category: "قياس الأداء",
      meta: "5 دقائق",
      image: "/images/articles/latest/metrics.webp",
    },
  ] satisfies HomeCard[],
  faq: [
    {
