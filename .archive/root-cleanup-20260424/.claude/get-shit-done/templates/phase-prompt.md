...
<!-- For checkpoint task examples and patterns, see @/media/amr/02D804FAD804EE2B/Busniss/SWEED-Website/.claude/get-shit-done/references/checkpoints.md -->
...
See `/media/amr/02D804FAD804EE2B/Busniss/SWEED-Website/.claude/get-shit-done/references/tdd.md` for TDD plan structure.
...
See `/media/amr/02D804FAD804EE2B/Busniss/SWEED-Website/.claude/get-shit-done/templates/user-setup.md` for full schema and examples
...
See `/media/amr/02D804FAD804EE2B/Busniss/SWEED-Website/.claude/get-shit-done/workflows/verify-phase.md` for verification logic.
